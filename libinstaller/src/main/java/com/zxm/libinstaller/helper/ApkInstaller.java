package com.zxm.libinstaller.helper;
...
import com.zxm.libinstaller.info.StateMessage;
import com.zxm.libinstaller.info.StateType;
import com.zxm.libinstaller.listener.OnInstallStateListener;
import com.zxm.libinstaller.service.InstallerService;
import com.zxm.libinstaller.utils.AccessibilityUtil;
import com.zxm.libinstaller.utils.Logger;
...
public final class ApkInstaller {
    ...
    public void startInstall(@NonNull String filePath) {
        final File file = AccessibilityUtil.getFileByPath(filePath);
        if (AccessibilityUtil.isFileExists(file)) {

            if (mStateListener != null) {
                mStateListener.onInstallStart(filePath);
            }

            final boolean isRoot = AccessibilityUtil.isDeviceRooted();
            Logger.d(TAG, "Current device is root?-->" + isRoot);
            if (isRoot) {
            ...
            Logger.e("The file path of apk is null or empty!");
        }
    }
        ...
        if (accessibilityEnabled == 1) {
            ...
            if (settingValue != null) {
                ...
                while (mStringColonSplitter.hasNext()) {
                    ...
                    Logger.d(TAG, "-------------- > accessibilityService :: " + accessibilityService + " " + service);
